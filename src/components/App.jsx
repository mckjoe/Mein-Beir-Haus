      ...
      `}</style>
        <div>
          ...
          <Switch>
            ...
            <Route path='/newkeg' render={(props)=><NewKegControl  kegList={this.state.masterKegList} onNewKegCreation={this.handleAddingNewKegToList} currentRouterPath={props.location.pathname} />} />
